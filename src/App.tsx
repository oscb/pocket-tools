...
export const api = new UserAPI(localStorage.getItem('token'), localStorage.getItem('req_token'));
...
class App extends React.Component {
  render() {
    const homeProps: HomeProps = {
      ...
      heading: 'Schedule article deliveries to your kindle with your articles saved in Pocket.'
    };
      ...
      <BrowserRouter>
        <div>
          <Route 
            exact={true} 
            path="/" 
            render={(e) => new RouterHome({...homeProps, ...e} as RouterHomeProps)}
          />
